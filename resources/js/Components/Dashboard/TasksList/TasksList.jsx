			...
			<div className="sm:px-6 lg:px-8">
					...
					>
						...
						{prioritySorting === "asc" && (
							<svg
								...
								strokeLinecap="round"
								strokeLinejoin="round"
								className="feather feather-arrow-up-circle duration-150 stroke-indigo-500 fill-indigo-100 hover:fill-indigo-200"
							>
								<circle cx="12" cy="12" r="10"></circle>
								<polyline
									strokeWidth={"1.5"}
				...
				<ul>
					{(!tasks.length || showingQuickTaskCreationForm) && (
						<li
							key={"quickTaskCreationForm"}
							className={"border-b border-b-slate-200"}
						>
							<form
								onSubmit={(e) =>
									handleQuickTaskCreationFormSubmit(e)
								}
								className={"flex"}
							>
								<label
								...
								<input
									...
									onBlur={(e) =>
										handleQuickTaskCreationFormTaskNameInputBlur(
											e,
										)
									}
									autoFocus
									...
									value={taskNameInput}
									id={"quickTaskCreationFormTaskNameInput"}
									className={
								...
								{showingQuickTaskCreationFormControls && (
									<div className={"flex items-center"}>
										<button
											ref={
												quickTaskCreationFormSaveButton
											}
											className={
