...
export const PriorityButton = ({ task, priorities, isActive, buttonClickHandler }) => {
    return (
        <button onClick={buttonClickHandler} className={`flex gap-2 w-full items-center rounded-sm hover:ring-slate-300 hover:ring-1 pl-2.5 pr-3 ${isActive ? "bg-white ring-1 ring-indigo-500" : ""}`}>
